...
function CONF_ProcessDroneVideo18_08_24_delays(grp_index,grp_file,groupname,cs_kernel_size_range,delay_range)
% grp_index=15637;
...
[cs_kernel_size_s,delay_s]=meshgrid(cs_kernel_size_range,delay_range);
...
% Model setup
model_names={'Model_OnlyDark_18_08_24_forvideo_lightanddark_varydelay'};
...
for k=1:numel(cs_kernel_size_s)
    ...
    assignin('base','light_delay',delay_s(k));
    assignin('base','dark_delay',delay_s(k));
