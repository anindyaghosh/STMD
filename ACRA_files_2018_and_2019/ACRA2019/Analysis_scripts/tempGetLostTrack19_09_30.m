...
if(strcmp(which_pc,'mecheng'))
    paramfile = load('D:\simfiles\conf2\trackerinfo\TrackerParamFile19_09_26.mat');
    load_dir = 'D:\temp\TrackerFull19_09_26\';
    trajfile = load('D:\simfiles\conf2\trackerinfo\trajectories19_09_06.mat');
    save_dir = 'D:\temp\';
elseif(strcmp(which_pc,'phoenix'))
    paramfile = load('/fast/users/a1119946/simfiles/conf2/data/trackerinfo/TrackerParamFile19_09_26.mat');
    trajfile = load('/fast/users/a1119946/simfiles/conf2/data/trackerinfo/trajectories19_09_06.mat');
    load_dir = '/fast/users/a1119946/simfiles/conf2/data/TrackerFull19_09_26/';
    save_dir = '/fast/users/a1119946/simfiles/conf2/data/processed/';
end

savename='temp_lost_it_19_09_30';
