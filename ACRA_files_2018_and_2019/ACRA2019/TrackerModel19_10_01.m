...
function TrackerModel19_10_01(param_settings_file, gind, groupname, hours_to_run, in_toc)
...
% % data_dir = 'D:\temp\';
% hours_to_run = 16/60;
% param_settings_file = 'D:\temp\TrackerParamFile19_09_26.mat';
% % param_settings_file = 'E:\PHD\TEST\TrackerParamFile19_09_26.mat';
% % E:\PHD\TEST
% groupname='something';
% 
% which_pc='mecheng';
            ...
            if(mod(tix,settings.output_integration)==0) % Time to update the tracker or histograms as the case may be
                ...
                if(settings.make_histograms)
                    ...
                    if(~spinning && tix > spin_ticks + 30)
                        ...
                        if(settings.use_prob_tracker)
                            if(acquired && (tix-saccade_end_tix) > settings.tix_after_saccade)
