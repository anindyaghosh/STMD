...
for test_ix = 1:num_tests;
    ...
    proceedwith=true;
    if(~make_histograms)
        savename=[outdir 'track_saccades_distract_' num2str(output_integration) '-' num2str(traj_range(test_ix)) '.mat'];
        if(exist(savename,'file'))
...
%                                 predict_deg = turn_deg - floor(predict_angle);
        ...
        if(~make_histograms)
            save(savename,...
                ...
                'obs_th_pos_history','max_output_history','distractorparams')
        end
