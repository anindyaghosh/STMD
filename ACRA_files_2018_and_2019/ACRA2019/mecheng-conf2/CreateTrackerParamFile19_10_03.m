...
fixed.constgain.value=2; % Gain to be applied to outputs in the gain field. 1 elsewhere.
...
outer_var.ranges.tracker = {'prob','prob_fixed',...
...
save('D:\simfiles\conf2\trackerinfo\TrackerParamFile19_10_03.mat',...
