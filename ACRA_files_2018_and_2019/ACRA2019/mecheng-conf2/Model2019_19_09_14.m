...
function TrackerModel19_09_14(param_settings_file, gind, data_dir, hours_to_run, in_toc)
...
toc_to_die = in_toc + hours_to_run*60*60 - 300;
...
if(strcmp(which_pc,'phoenix'))
    ...
    settings.im_loc = '/fast/users/a1119946/simfiles/texture/';
