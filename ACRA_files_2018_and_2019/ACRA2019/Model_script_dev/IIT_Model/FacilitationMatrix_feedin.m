function [Facilitation,Delayed_Grid,Facilitationbuffer]=FacilitationMatrix_feedin(Grid, Col_index,Default, Ts, wb, Delayed_Grid,Facilitationbuffer)
    % Removed persistent variables by feeding in and out
    [m,n]=size(Grid);
