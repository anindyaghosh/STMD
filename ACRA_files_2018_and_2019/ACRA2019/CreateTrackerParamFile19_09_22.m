...
fixed.prob.turn_threshold = best_set.prob.turn_threshold;
...
fixed.fac.sigma = best_set.fac.sigma;
fixed.fac.kernel_spacing = best_set.fac.kernel_spacing;
fixed.fac.emd_timeconstant = best_set.fac.emd_timeconstant;
fixed.fac.lpf_timeconstant = best_set.fac.lpf_timeconstant;
fixed.fac.distance_turn_threshold = best_set.fac.distance_turn_threshold;
fixed.fac.direction_predict_distance = best_set.fac.direction_predict_distance;
fixed.fac.direction_predict_threshold = best_set.fac.direction_predict_threshold;
fixed.fac.direction_turn_threshold = best_set.fac.direction_turn_threshold;
fixed.fac.tix_between_saccades = best_set.fac.tix_between_saccades;
...
save('E:\PHD\conf2\data\trackerinfo\TrackerParamFile19_09_22.mat',...
    'this_script','outer_ix','inner_ix','fixed','params_set','params_range','outer_var','inner_var')
