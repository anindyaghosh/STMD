...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:38:47 AM;
timing_error = 0;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313103846;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 168.04999999999998;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1053.3875107031758;
...
my_length = 35917; % Length of recording
fid = fopen('cell5_dragon3090313_103839.dat','r','b'); % Open binary data as IEEE-32bit big-endian
