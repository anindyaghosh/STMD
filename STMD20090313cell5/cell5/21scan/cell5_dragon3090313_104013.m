...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:40:21 AM;
timing_error = 0;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313104020;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 97.099999999999994;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1147.3124240650698;
...
my_length = 35896; % Length of recording
fid = fopen('cell5_dragon3090313_104013.dat','r','b'); % Open binary data as IEEE-32bit big-endian
