...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:38:04 AM;
timing_error = 0;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313103803;
BG_angular_velocity = 2.0;
BG_colorB = 1.0;
BG_colorG = 1.0;
BG_colorR = 1.0;
BG_contrast = 0.20000000000000001;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 26.149999999999999;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1010.6612055442801;
...
my_length = 35944; % Length of recording
fid = fopen('cell5_dragon3090313_103757.dat','r','b'); % Open binary data as IEEE-32bit big-endian
