...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:40:12 AM;
timing_error = 1;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313104012;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 215.34999999999999;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1138.7551618990681;
...
my_length = 35936; % Length of recording
fid = fopen('cell5_dragon3090313_104005.dat','r','b'); % Open binary data as IEEE-32bit big-endian
