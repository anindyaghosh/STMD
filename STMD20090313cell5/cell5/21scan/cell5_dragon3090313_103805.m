...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:38:12 AM;
timing_error = 0;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313103812;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 73.449999999999989;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1019.2034613337729;
...
my_length = 35928; % Length of recording
fid = fopen('cell5_dragon3090313_103805.dat','r','b'); % Open binary data as IEEE-32bit big-endian
