...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:38:38 AM;
timing_error = 1;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313103838;
...
BG_update_pic = 0;
TG1_centre_x0 = 320.0;
TG1_centre_y0 = 428.19999999999999;
TG1_colorA = 1.0;
TG1_colorB = 1.0;
TG1_colorG = 0.0;
TG1_colorR = 0.0;
...
go_loop_start_time_abs_sec = 1044.8452568692389;
...
my_length = 35933; % Length of recording
fid = fopen('cell5_dragon3090313_103831.dat','r','b'); % Open binary data as IEEE-32bit big-endian
