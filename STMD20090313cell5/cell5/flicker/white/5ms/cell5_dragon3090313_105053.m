...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:50:55 AM;
timing_error = 1;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313105055;
...
post_stim_sec = 1.0;
pre_stim_sec = 1.0;
stim_sec = 0.0050000000000000001;
frames_dropped = 1; % boolean;
go_loop_start_time_abs_sec = 1785.7828679343324;
...
my_length = 11044; % Length of recording
fid = fopen('cell5_dragon3090313_105053.dat','r','b'); % Open binary data as IEEE-32bit big-endian
