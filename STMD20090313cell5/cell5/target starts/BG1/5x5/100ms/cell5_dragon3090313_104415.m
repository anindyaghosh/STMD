...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:44:17 AM;
timing_error = 1;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313104417;
...
post_stim_sec = 1.0;
pre_stim_sec = 1.0;
stim_sec = 0.10000000000000001;
frames_dropped = 0; % boolean;
go_loop_start_time_abs_sec = 1388.1802670451132;
...
my_length = 11411; % Length of recording
fid = fopen('cell5_dragon3090313_104415.dat','r','b'); % Open binary data as IEEE-32bit big-endian
