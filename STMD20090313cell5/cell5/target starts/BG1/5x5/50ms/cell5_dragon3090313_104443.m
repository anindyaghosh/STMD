...
% Do not edit
% Parameter file saved on Friday, 13 March 2009 at 10:44:45 AM;
timing_error = 0;
% Vision Egg parameters
stim_type = 'dragon3';
finished_time = 20090313104445;
...
post_stim_sec = 1.0;
pre_stim_sec = 1.0;
stim_sec = 0.050000000000000003;
frames_dropped = 0; % boolean;
go_loop_start_time_abs_sec = 1416.0563250357238;
...
my_length = 11167; % Length of recording
fid = fopen('cell5_dragon3090313_104443.dat','r','b'); % Open binary data as IEEE-32bit big-endian
